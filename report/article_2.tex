...
\usepackage[hmarginratio=5:5,top=32mm,columnsep=20pt]{geometry} % Document margins
...
%	ARTICLE CONTENTS
%----------------------------------------------------------------------------------------
\section{Introduction to the parallelised solution}

As an initial attempt, we began by implementing a single-threaded Game of Life (GoL) Engine, expanding upon this work with parallelisation by virtue of concurrent go-routine workers. Recognising that branch instructions throttled efficiency of \texttt{getNeighbourCount}, we removed if-statements, introduced bit-masking and assignment which drastically improving runtime. 
...
\section{parralelising the program}
...
\section{parallelising benchmark and critical analysis}
